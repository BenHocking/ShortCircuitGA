...
public class AbstractFitnessTest {
    ...
    /**
     * Test method for {@link edu.virginia.cs.geneticalgorithm.AbstractFitness#totalFitness()}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link edu.virginia.cs.geneticalgorithm.AbstractFitness#checkFitnessSize(edu.virginia.cs.geneticalgorithm.Fitness, java.util.List)}
     * .
     */
    @Test
    public final void testCheckFitnessSize() {
        ...
        try {
            ...
            assertEquals("Program error resulted in unexpected number of fitness values", e.getMessage());
        }
    }
